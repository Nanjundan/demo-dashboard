...
class AppComponent {
    ...
    ngOnInit() {
        this.http.downloadFile('../assets/configuration/seat_allocation_by_office_and_floor_config').subscribe(data => {
            this.dashboardConfig = data;
        });
        this.http.downloadFile('../assets/template/seat_allocation_by_office_and_floor_template').subscribe(data => {
